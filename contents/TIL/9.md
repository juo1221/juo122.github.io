...
그러던 중 **HOC (higher order component)** 라는 개념에 대해 알게 됐다.

HOC란 컴포넌트를 인자로 받아 새로운 컴포넌트로 반환하는 컴포넌트임을 의미한다. 

HOC를 사용해서 위 중복 로직을 제거하고 컴포넌트를 재사용해 보자. 
